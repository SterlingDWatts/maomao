...
export const availableNow: AvailableNowProps[] = [
  ...
  },
  {
    ...
    subheader: "The Jade Earring, Part 2",
    season: 1,
    episode: 2,
    episodesInSeason: 13,
    cardMedia: Raven.src,
    cardMediaAlt: "Raven of The Inner Palace",
    releaseDateTime: "October 08 2020 03:00:00 GMT-0700",
    synopsis: `Shouxue takes on a familiar face to be her lady-on-waiting to continue one the trail of the mystery revolving around the ghost linked to the jade earring. Background of both Shouxue and the Emperor are revealed.`,
    watchUrl:
      "https://www.crunchyroll.com/series/GP5HJ8E99/raven-of-the-inner-palace",
    imdbUrl: "https://www.imdb.com/title/tt22530222/?ref_=ttep_ep_2",
    objectPosition: "50% 50%",
    SiteLogo: CrunchyrollLogo,
  },
];
