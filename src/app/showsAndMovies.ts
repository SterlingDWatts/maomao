...
export const availableNow: AvailableNowProps[] = [
  ...
  },
  {
    ...
    title: "Dr. Stone",
    subheader: "Humanity's Strongest Tag Team",
    season: 2,
    episode: 10,
    cardMedia: Stone.src,
    cardMediaAlt: "Dr. Stone",
    releaseDateTime: "July 18 2021 03:00:00 GMT-0700",
    synopsis: `A truce is called between the Kingdom of Science and Tsukasa Empire. All appears to be well, but some of the Kingdom's dynamite is missing.`,
  ...
  },
  {
    avatar: Fruits.src,
    title: "Fruits Basket",
    subheader: "Let's Go Home",
    season: 1,
    episode: 24,
    cardMedia: Fruits.src,
    cardMediaAlt: "Fruits Basket",
    releaseDateTime: "September 14 2019 03:00:00 GMT-0700",
    synopsis: `Kazuma Soma's visit to the house is more than a casual visit, especially for Kyo. Will we finally find out Kyo's secret?`,
  ...
  },
  {
    avatar: Kaiju.src,
    title: "Kaiju No. 8",
    subheader: "The Kaiju Who Defeats Kaiju",
    season: 1,
    episode: 2,
    cardMedia: Kaiju.src,
    cardMediaAlt: "Kaiju No. 8",
    releaseDateTime: "April 20 2024 03:00:00 GMT-0700",
    synopsis: `After turning into a Kaiju, Kafka is forced to flee. His escape is interrupted, however, by the arrival of another Kaiju...`,
