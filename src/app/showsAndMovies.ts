...
export const availableNow: AvailableNowProps[] = [
  ...
  },
  {
    ...
    subheader: "The Masked Man",
    season: 1,
    episode: 10,
    episodesInSeason: 13,
    cardMedia: Raven.src,
    cardMediaAlt: "Raven of The Inner Palace",
    releaseDateTime: "December 03 2020 03:00:00 GMT-0700",
    synopsis: `Gaojun uncharacteristically appears lonely. Though Shouxue is concerned, she is unable to ask why. Several days later, Gaojun visits Ye Ming Palace to show her a haunted mask. The ghost haunting the mask apparently responds to a type of foreign lute. The problem is solved when Gaojun is able to provide such a lute. Gaojun tries to leave, but he is stopped by Shouxue.`,
    watchUrl:
      "https://www.crunchyroll.com/series/GP5HJ8E99/raven-of-the-inner-palace",
    imdbUrl: "https://www.imdb.com/title/tt23984802/?ref_=ttep_ep_10",
    objectPosition: "50% 50%",
    SiteLogo: CrunchyrollLogo,
  },
  {
    ...
    subheader: "Court Cuisine/Boiled in Salt Water",
    season: 1,
    episode: 6,
    episodesInSeason: 24,
    cardMedia: Delicious.src,
    cardMediaAlt: "Delicious in Dungeon",
    releaseDateTime: "February 08 2024 03:00:00 GMT-0700",
    synopsis: `Laios takes a dive into some living paintings, angering an elf. Chilchuck gets trapped with a mimic.`,
    watchUrl:
      "https://www.netflix.com/us/title/81564899?s=a&trkid=13747225&trg=cp&vlang=en&clip=81751898",
    imdbUrl: "https://www.imdb.com/title/tt30838271/?ref_=ttep_ep_6",
    objectPosition: "50% 50%",
  ...
  },
  {
    ...
    imdbUrl: "https://www.imdb.com/title/tt13152038/?ref_=ttep_ep_5",
    synopsis:
...
export const upNext: UpNextProps[] = [
  ...
  // },
  {
    ...
    releaseDateTime: "September 22, 2025 21:00:00",
    watchUrl:
  ...
  },
  {
    ...
    cardMedia: MyHeroFinalSeason.src,
    cardMediaAlt: "My Hero Academia Season 8",
    releaseDateTime: "November 14, 2025 01:30:00",
    watchUrl: "https://www.crunchyroll.com/series/G6NQ5DWZ6/my-hero-academia",
    objectPosition: "50% 50%",
    TimerCard: SmallTimerCard,
    SiteLogo: CrunchyrollLogo,
