...
export const availableNow: AvailableNowProps[] = [
  ...
  },
  {
    ...
    title: "Kaiju No. 8",
    subheader: "The Strongest Division",
    season: 2,
    episode: 3,
    episodesInSeason: 11,
    cardMedia: Kaiju.src,
    cardMediaAlt: "Kaiju No. 8",
    releaseDateTime: "August 02 2025 03:00:00 GMT-0700",
    synopsis: `Kaiju No. 9 appears for the third time, splitting in two and overwhelming the Defense Force.`,
  ...
  },
  {
    ...
    subheader: "The Iron Pot",
    season: 1,
    episode: 5,
    episodesInSeason: 7,
    cardMedia: Creature.src,
    cardMediaAlt: "Creature Commandos",
    releaseDateTime: "December 26 2024 16:00:00 GMT-0700",
