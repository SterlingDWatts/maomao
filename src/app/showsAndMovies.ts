...
export const availableNow: AvailableNowProps[] = [
  ...
  },
  {
    avatar: Fruits.src,
    title: "Fruits Basket",
    subheader: "Ask Him For Me",
    season: 2,
    episode: 16,
    episodesInSeason: 25,
    cardMedia: Fruits.src,
    cardMediaAlt: "Fruits Basket",
    releaseDateTime: "July 21 2020 03:00:00 GMT-0700",
    synopsis: `Tohru takes it upon herself to venture into the Soma Estate where she meets someone unexpected.`,
    watchUrl: "https://www.crunchyroll.com/series/G6ZJMGEXY/fruits-basket",
    imdbUrl: "https://www.imdb.com/title/tt12683990/?ref_=ttep_ep_16",
    objectPosition: "50% 50%",
    SiteLogo: CrunchyrollLogo,
  },
  {
    avatar: Gurren.src,
    title: "Gurren Lagann",
    subheader: "Let's Go, This Is the Final Battle",
    season: 1,
    episode: 23,
    episodesInSeason: 27,
    cardMedia: Gurren.src,
    cardMediaAlt: "Gurren Lagann",
    releaseDateTime: "November 03 2007 03:00:00 GMT-0700",
    synopsis: `Team Dai-Gurren keeps the Anti-Spirals attack off. Meanwhile, Rossiu goes to his home, Adai.`,
